...
SOURCES = \
	__init__.py \
	BHCgeoQGIS.py BHCgeoQGIS_dialog.py

PLUGINNAME = BHCgeoQGIS

PY_FILES = \
	__init__.py \
	BHCgeoQGIS.py BHCgeoQGIS_dialog.py

UI_FILES = BHCgeoQGIS_dialog_base.ui
...
QGISDIR=C:\Users\Dell\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
